...
8. Rename the addaction strings in UAV operator's init, replacing BLACKFISH
   with AC-130:
       e.g. "BLACKFISH - WAYPOINTING" becomes "AC-130 - WAYPOINTING"

OPTIONAL 2: add a script which makes the blackfish bullets land on the
crosshair rather than all the way to the side:
